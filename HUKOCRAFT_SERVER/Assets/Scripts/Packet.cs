...
//PACKETS THAT ARE SENT FROM SERVER TO CLIENT (SENDING)
...
//PACKETS THAT ARE SENT FROM CLIENT TO SERVER (RECEIVED PACKETS - NEEDS TO BE HANDLE)
...
public class Packet : IDisposable
{
    ...
    //CREATES A NEW PACKET WITH GIVEN ID (HEAL PACKET, DEATH PACKET, POSITION PACKET...)(USED FOR SENDING)
